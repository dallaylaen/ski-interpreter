...
class App extends Expr {
  ...
  _unspaced (arg) {
    return this.arg.needsParens(false) ? true : this.arg._unspaced(arg);
  }
}
 ...
 * @return {string[]}
 */
function emitDeclarations (inventory) {
...
module.exports = { Expr, App, FreeVar, Lambda, Native, Alias, Church, globalOptions, native, emitDeclarations };
