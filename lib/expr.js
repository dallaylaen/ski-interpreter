...
// lambda placeholder, TODO make it meaningful but not now
const lambdaPlaceholder = new Native('->', 1, x => x, {
...
class Lambda extends Expr {
  ...
  getSymbols () {
    ...
    out.delete(this.arg);
    out.set(lambdaPlaceholder, (out.get(lambdaPlaceholder) ?? 0) + 1);
    return out;
  }
...
module.exports = { Expr, App, FreeVar, Lambda, Native, Alias, Church, globalOptions, lambdaPlaceholder };
