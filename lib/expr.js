...
class Expr {
  ...
  canonize (options = {}, preArgs = [], steps = 0) {
    ...
    if (!next.final)
      return { grounded: false, steps: next.steps + steps };
    return next.expr.canonize(options, [...preArgs, pushVar], next.steps + steps);
  }
  ...
  canonize (options = {}, preArgs = [], steps = 0) {
    ...
    if (this.freeOnly()) {
      ...
      const forward = this.wantsArgs()
        ...
        : { grounded: false, steps: 0 };
      if (forward.grounded)
        return forward; // better never happens
...
class Lambda extends Expr {
  ...
  canonize (options = {}, preArgs = []) {
    ...
    return (simplified.final ? simplified.expr : next)
      .canonize(options, [...preArgs, nextVar]);
  }
