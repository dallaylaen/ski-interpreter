...
import { FormatOptions, Expr, Named } from '../../../src/expr';
...
function check (src: string, options: FormatOptions, result: string, comment?: string) {
  describe(src, () => {
...
function sameAs (src: string, expr: Expr, comment: string) {
