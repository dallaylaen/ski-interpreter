...
describe('Expr.diag: basic expressions', () => {
  ...
  it('distinguishes different free variables with ids', () => {
    const x1 = new SKI.classes.FreeVar('x', 1 as unknown as object);
    const x2 = new SKI.classes.FreeVar('x', 2 as unknown as object);
...
function indentCount (text: string): number[] {
